...
procedure Maps_Test is
   ...
   package Maps is new Maps_G (Key_Type   => ASU.Unbounded_String,
                               Value_Type => ASU.Unbounded_String, --record
                               "="        => ASU."=",
							   Max 			=> 5);
...
begin
   ...
   Maps.Put (A_Map,
             ASU.To_Unbounded_String ("bea.com"),
             ASU.To_Unbounded_String ("53.63.189.16"));
             
   Maps.Put (A_Map,
             ASU.To_Unbounded_String ("antonio.com"),
             ASU.To_Unbounded_String ("69.63.169.16"));
             
   Maps.Put (A_Map,
             ASU.To_Unbounded_String ("pepe.com"),
             ASU.To_Unbounded_String ("69.63.189.16"));
